...
# def logistic_newtons_method(theta0, theta1, features , target_values , num_iterations=10000, tolerance=1e-6):
...
# theta0_log, theta1_log = logistic_newtons_method(theta0_log, theta1_log, x, y)

# query_point = 23

# print(f"Prediction for {query_point}:", sigmoid(theta0_log + theta1_log*query_point))
